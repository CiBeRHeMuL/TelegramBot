 ...
 */
class SuggestedPostPrice extends AbstractEntity
{
    /**
     * @param CurrencyEnum $currency Currency in which the post will be paid. Currently, must be one of “XTR” for Telegram Stars or
     * “TON” for toncoins
