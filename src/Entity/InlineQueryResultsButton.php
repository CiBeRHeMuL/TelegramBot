...
/**
 * @moduleContract
 * @purpose Represents a button to be shown above inline query results.
 *
 * @sees USES_API(7): Telegram Bot API https://core.telegram.org/bots/api#inlinequeryresultsbutton
 *
 * @changes LAST_CHANGE: Initial creation with semantic documentation markup
 */
// endregion MODULE_CONTRACT
// GREP_SUMMARY: InlineQueryResultsButton, Telegram, Bot API, DTO, inlinequeryresultsbutton
// STRUCTURE: ▶ ┌text┐ → ◇ web_app/start_parameter → ∑ button
// region CLASS_InlineQueryResultsButton
...
// endregion CLASS_InlineQueryResultsButton
