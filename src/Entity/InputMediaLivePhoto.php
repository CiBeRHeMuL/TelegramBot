...
/**
 * @moduleContract
 * @purpose Represents a live photo to be sent.
 *
 * @sees USES_API(7): Telegram Bot API https://core.telegram.org/bots/api#inputmedialivephoto
 *
 * @changes LAST_CHANGE: Initial creation with semantic documentation markup
 */
// endregion MODULE_CONTRACT
// GREP_SUMMARY: InputMediaLivePhoto, Telegram, Bot API, DTO, inputmedialivephoto
// STRUCTURE: ▶ ┌media(FileUrlStr)┐ → ◇ caption,parse_mode → ∑ InputMediaLivePhoto
// region CLASS_InputMediaLivePhoto
...
// endregion CLASS_InputMediaLivePhoto
