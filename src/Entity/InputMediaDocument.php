...
/**
 * @moduleContract
 * @purpose Represents a general file to be sent.
 *
 * @sees USES_API(7): Telegram Bot API https://core.telegram.org/bots/api#inputmediadocument
 *
 * @changes LAST_CHANGE: Initial creation with semantic documentation markup
 */
// endregion MODULE_CONTRACT
// GREP_SUMMARY: InputMediaDocument, Telegram, Bot API, DTO, inputmediadocument
// STRUCTURE: ▶ ┌media(FileUrlStr)┐ → ◇ thumbnail,caption,parse_mode → ∑ InputMediaDocument
// region CLASS_InputMediaDocument
...
final class InputMediaDocument extends AbstractInputMedia implements InputPollMediaInterface
{
    /**
...
// endregion CLASS_InputMediaDocument
