...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API editMessageChecklist method.
 *
...
// GREP_SUMMARY: edit message checklist, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result┐ → ◇ isOk()? : ⊕ Message

// region CLASS_EditMessageChecklistResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_EditMessageChecklistResponse
