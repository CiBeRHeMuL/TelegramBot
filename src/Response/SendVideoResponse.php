...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API sendVideo method.
 *
...
// GREP_SUMMARY: send video, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result┐ → ◇ isOk()? : ⊕ Message

// region CLASS_SendVideoResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_SendVideoResponse
