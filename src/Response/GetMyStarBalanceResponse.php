...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API getMyStarBalance method.
 *
...
// GREP_SUMMARY: get my star balance, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result┐ → ◇ isOk()? : ⊕ StarAmount

// region CLASS_GetMyStarBalanceResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_GetMyStarBalanceResponse
