...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API sendVideoNote method.
 *
...
// GREP_SUMMARY: send video note, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result┐ → ◇ isOk()? : ⊕ Message

// region CLASS_SendVideoNoteResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_SendVideoNoteResponse
