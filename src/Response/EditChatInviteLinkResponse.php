...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API editChatInviteLink method.
 *
...
// GREP_SUMMARY: edit chat invite link, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result┐ → ◇ isOk()? : ⊕ ChatInviteLink

// region CLASS_EditChatInviteLinkResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_EditChatInviteLinkResponse
