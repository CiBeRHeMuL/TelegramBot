...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API getMyName method.
 *
...
// GREP_SUMMARY: get my name, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result┐ → ◇ isOk()? : ⊕ BotName

// region CLASS_GetMyNameResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_GetMyNameResponse
