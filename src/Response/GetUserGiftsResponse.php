...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API getUserGifts method.
 *
...
// GREP_SUMMARY: get user gifts, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result┐ → ◇ isOk()? : ⊕ OwnedGifts

// region CLASS_GetUserGiftsResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_GetUserGiftsResponse
