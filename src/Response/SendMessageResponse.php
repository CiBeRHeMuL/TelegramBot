...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API sendMessage method.
 *
...
// GREP_SUMMARY: send message, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result┐ → ◇ isOk()? : ⊕ Message

// region CLASS_SendMessageResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_SendMessageResponse
