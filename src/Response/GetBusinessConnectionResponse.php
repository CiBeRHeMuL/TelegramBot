...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API getBusinessConnection method.
 *
...
// GREP_SUMMARY: get business connection, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result┐ → ◇ isOk()? : ⊕ BusinessConnection

// region CLASS_GetBusinessConnectionResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_GetBusinessConnectionResponse
