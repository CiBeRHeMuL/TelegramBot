...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API createChatSubscriptionInviteLink method.
 *
...
// GREP_SUMMARY: create chat subscription invite link, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result┐ → ◇ isOk()? : ⊕ ChatInviteLink

// region CLASS_CreateChatSubscriptionInviteLinkResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_CreateChatSubscriptionInviteLinkResponse
