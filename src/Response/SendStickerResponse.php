...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API sendSticker method.
 *
...
// GREP_SUMMARY: send sticker, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result┐ → ◇ isOk()? : ⊕ Message

// region CLASS_SendStickerResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_SendStickerResponse
