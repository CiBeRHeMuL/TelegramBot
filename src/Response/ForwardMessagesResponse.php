...
/**
 * @moduleContract
 * @purpose Response DTO for Telegram Bot API forwardMessages method.
 *
...
// GREP_SUMMARY: forward messages, response, Telegram Bot API
// STRUCTURE: ▶ ┌ok + result([])┐ → ◇ isOk()? : ⊕ MessageId[]

// region CLASS_ForwardMessagesResponse [DOMAIN(7): Telegram; CONCEPT(8): BotAPI; TECH(7): Response]
...
// endregion CLASS_ForwardMessagesResponse
