...
/**
 * @moduleContract
 * @purpose Request DTO for Telegram Bot API sendGift method.
 *
...
// GREP_SUMMARY: Telegram, Bot API, Request, Send, Gift
// STRUCTURE: ▶ ┌gift_id + chat_id + pay_for_upgrade + text + text_entities┐ → ◇ construct → ⊕ → ∑ ⟦SendGiftRequest⟧

// region CLASS_SendGiftRequest
/**
 * @see https://core.telegram.org/bots/api#sendgift
 */
...
// endregion CLASS_SendGiftRequest
