...
/**
 * @moduleContract
 * @purpose Request DTO for Telegram Bot API sendContact method.
 *
...
// GREP_SUMMARY: Telegram, Bot API, Request, Send, Contact
// STRUCTURE: ▶ ┌chat_id + first_name + phone_number + business_connection_id + disable_notification┐ → ◇ construct → ⊕ → ∑ ⟦SendContactRequest⟧

// region CLASS_SendContactRequest
/**
 * @see https://core.telegram.org/bots/api#sendcontact
 */
...
// endregion CLASS_SendContactRequest
