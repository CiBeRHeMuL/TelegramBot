...
/**
 * @moduleContract
 * @purpose Request DTO for Telegram Bot API getUserGifts method.
 *
...
// GREP_SUMMARY: Telegram, Bot API, Request, Get, User, Gifts
// STRUCTURE: ▶ ┌user_id + exclude_from_blockchain + exclude_limited_non_upgradable + exclude_limited_upgradable + exclude_unique┐ → ◇ construct → ⊕ → ∑ ⟦GetUserGiftsRequest⟧

// region CLASS_GetUserGiftsRequest
/**
 * @see https://core.telegram.org/bots/api#getusergifts
 */
...
// endregion CLASS_GetUserGiftsRequest
